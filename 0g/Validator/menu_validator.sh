...
while true; do
  ...
  echo "1) ${B_YELLOW}💰${NO_COLOR} Забрать комиссии и реварды валидатора"
  echo "2) ${B_GREEN}💸${NO_COLOR} Забрать все реварды со всех кошельков"
  echo "3) 📥 Делегировать со всех кошельков в своего валидатора"
  echo "4) 🗳  Голосование по пропозалу"
  echo "5) 🚪 Вызволить из тюрьмы"
  echo "6) 📡 Мониторинг"
  echo "7) ${B_RED}❌${NO_COLOR} Выход"
